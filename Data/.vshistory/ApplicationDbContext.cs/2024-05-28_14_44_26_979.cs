    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var adminUser = new ApplicationUser
            {
                ...
                Email = "agriadmin@agri.com",
                NormalizedEmail = "AGRIADMIN@AGRI.COM",
                EmailConfirmed = true,
            ...
            {
                Id = employeeUserId,
                UserName = "AgriEmployee1",
                FirstName = "Employee",
                LastName = "Agri",
                NormalizedUserName = "AGRIEMPLOYEE1",
                Email = "AgriEmployee1@agri.com",
                NormalizedEmail = "AGRIEMPLOYEE1@AGRI.COM",
                EmailConfirmed = true,
