...
public class UsersController : Controller
{
    ...
    // GET: Users/AdminDeleteAccount
    public IActionResult AdminDeleteAccount()
    {
        return View();
    }

    // POST: Users/AdminDeleteAccount
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> AdminDeleteAccount(string userId)
    {
