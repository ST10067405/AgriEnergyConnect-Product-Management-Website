...
namespace AgriEnergyConnect.Controllers
{
    public class ProductsController : Controller
    {
        ...
        // GET: Products
        public async Task<IActionResult> Index(string productName, string productType, DateOnly? startDate, DateOnly? endDate)
        {
            ...
            // Get distinct product types for dropdown list
            var productTypes = await productsQuery.Select(p => p.Category).Distinct().ToListAsync();
            ...
            var model = new ProductFilterViewModel
            {
                ...
                StartDate = startDate,
                EndDate = endDate,
                ProductTypes = productTypes.Select(pt => new SelectListItem { Text = pt, Value = pt }).ToList(),
