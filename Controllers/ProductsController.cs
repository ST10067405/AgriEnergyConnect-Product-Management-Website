...
namespace AgriEnergyConnect.Controllers
{
    public class ProductsController : Controller
    {
        ...
        // GET: Products
        public async Task<IActionResult> Index(string productName, DateOnly? startDate, DateOnly? endDate, string category, string farmerId = null)
        {
            ...
            {
                productsQuery = productsQuery.Where(p => p.ApplicationUser.Id == farmerId);
            }
